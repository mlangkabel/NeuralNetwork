...
public:
	void test_node_group_linear_excitation_can_be_loaded_from_xml_element()
	{
		...
		std::shared_ptr<NeuralNodeGroupLinearExcitationCpu> nodeGroup = NeuralNodeGroupLinearExcitationCpu::loadFromXmlElement(element);
	...
	{
		NeuralNodeGroupLinearExcitationCpu nodeGroup(1, 5, 1.0f);
	...
	{
		NeuralNodeGroupLinearExcitationCpu nodeGroup(1, 1, 1.0f);
	...
	{
		NeuralNodeGroupLinearExcitationCpu nodeGroup(1, 2, 0.5f);
	...
	void test_node_group_step_excitation_can_be_loaded_from_xml_element()
	{
		...
		std::shared_ptr<NeuralNodeGroupStepExcitationCpu> nodeGroup = NeuralNodeGroupStepExcitationCpu::loadFromXmlElement(element);
	...
	{
		NeuralNodeGroupStepExcitationCpu nodeGroup(1, 4, 0.5f, 0.0f);
	...
	{
		NeuralNodeGroupStepExcitationCpu nodeGroup(1, 4, 0.5f, 1.0f);
